...
void RoomSelectionState::drawTop()
{
    ...
    C2D_DrawText(appVersionText, C2D_WithColor | C2D_AtBaseline, 400 - 4 - width, 240 - 4, 0.5f, textScale, textScale, textColor);
}
...
void RoomSelectionState::update()
{
    ...
    else if(kDown & KEY_A)
    {
        ...
        if(this->selected == 0)
        {
            ...
            this->nextState = new PlayingState(true);
        }
        ...
        else
        {
            ...
            currentRoom->join();
            this->nextState = new PlayingState(false);
        }
    }
